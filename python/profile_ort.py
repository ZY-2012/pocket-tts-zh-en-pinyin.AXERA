...
MODEL_ROOT = os.environ.get("POCKET_TTS_ROOT", "/data/shared/huyuan/TTS/pocket-tts-zh-en-pinyin")
...
from pinyin_frontend import text2ids as pinyin_text2ids  # noqa: E402
...
def main() -> None:
    ...
    ap.add_argument("--model", default="step_onnx_int8", choices=["step_onnx_int8", "step_onnx_int8"])
